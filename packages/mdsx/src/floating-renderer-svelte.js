...
import { createSnippet } from './unified/svelte.js'
...
function renderMarkdown(md) {
  ...
  const elemet = /** @type import('hast').Element */ (toHast(mdast, toHastOptions))

  return elemet.children
}
